...
#include <ros2can/msg/wheel_velocity_command.hpp>
...
public:
  Velocity2OmniNode() : Node("velocity2omni_node")
  {
    ...
    publisher_ = this->create_publisher<ros2can::msg::WheelVelocityCommand>("wheel_vel", 10);
    subscription_ = this->create_subscription<ros2can::msg::RobotVelocityCommand>(
...
private:
  void robot_vel_callback(const ros2can::msg::RobotVelocityCommand::SharedPtr msg)
  {
    ros2can::msg::WheelVelocityCommand cmd;
  ...
  rclcpp::Publisher<ros2can::msg::WheelVelocityCommand>::SharedPtr publisher_;
  rclcpp::Subscription<ros2can::msg::RobotVelocityCommand>::SharedPtr subscription_;
};
